...
- `scenarios/login.js`: Password-Login ueber Supabase Auth.
...
Fuer automatische Test-User-Erstellung:
...
- `K6_LOGIN_USERS`: eine `email,password` Kombination pro Zeile
- alternativ `K6_LOGIN_USERS_FILE`: Datei mit `email,password` pro Zeile
...
$env:TEST_USER_PASSWORD="VeryStrongTestPassword123!"

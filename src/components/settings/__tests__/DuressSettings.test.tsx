...
// Supabase client is still used to look up the user's encryption salt
// from `profiles`, but the duress setup must no longer touch the
// `vault_items` legacy table directly — see DuressSettings.tsx for the
// rationale.

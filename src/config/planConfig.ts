...
export const PLAN_CONFIG: Record<PlanKey, PlanInfo> = {
    premium_monthly: {
        priceId: 'price_1Sz4ydPOxkvnea3yiUS9yZsV',
        tier: 'premium',
    ...
    premium_yearly: {
        priceId: 'price_1Sz4ydPOxkvnea3yjs4Tfnzt',
        tier: 'premium',
    ...
    families_monthly: {
        priceId: 'price_1Sz4yePOxkvnea3ywl0Ggaqj',
        tier: 'families',
    ...
    families_yearly: {
        priceId: 'price_1Sz4ygPOxkvnea3yy7lrqSmP',
        tier: 'families',

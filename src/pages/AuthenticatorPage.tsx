...
export default function AuthenticatorPage() {
    ...
    return (
        <FeatureGate feature="builtin_authenticator" featureLabel={t('authenticator.title')}>
            <div className="container py-6 px-4 md:px-6 max-w-6xl mx-auto space-y-6">

                {/* Header */}
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">{t('authenticator.title')}</h1>
                        <p className="text-muted-foreground mt-1">
                            {t('authenticator.subtitle')}
                        </p>
                    </div>

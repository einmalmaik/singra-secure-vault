...
function IssueCard({
    ...
    return (
        <Link
            ...
            className={cn(
                'flex w-full flex-wrap items-start gap-3 rounded-lg border p-3 transition-all sm:flex-nowrap sm:items-center',
        ...
        >
            ...
            <div className="min-w-0 flex-1 text-left">
                ...
                <p className="break-words text-xs text-muted-foreground">{getDescription()}</p>
                {issue.types.length > 1 && (
                    <p className="mt-1 text-[11px] text-muted-foreground">{issueTypeLabel}</p>
                )}
            </div>
            <Badge
                variant="outline"
...
export default function VaultHealthPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gradient-to-br from-primary/5 via-background to-primary/10">
            ...
            <main className="container mx-auto max-w-4xl flex-1 px-4 py-6 sm:py-8">
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-8">
                            ...
                            <Card className="overflow-hidden">
                                <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent p-5 sm:p-8">
                                    <div className="flex flex-col items-center gap-6 md:flex-row md:gap-8">
                                        <ScoreRing score={report.score} />
                                        <div className="text-center md:text-left space-y-2">
                                            <h2 className="singra-headline-serif text-2xl font-bold">
                            ...
                            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 md:grid-cols-5">
                                ...
                                <Card className={cn(
                                    'cursor-pointer transition-all hover:scale-105',
                                    filter === 'pwned' && 'ring-2 ring-red-500'
                                )} onClick={() => setFilter(filter === 'pwned' ? 'all' : 'pwned')}>
                                    <CardContent className="p-3 text-center sm:p-4">
                                        <ShieldAlert className="w-6 h-6 mx-auto text-red-500 mb-2" />
                                        <p className="text-2xl font-bold">{report.stats.pwned}</p>
                                        <p className="text-xs text-muted-foreground">
                                            {t('vaultHealth.pwned', { defaultValue: issueLabelDefaultValues.pwned })}
                                        </p>
                                    </CardContent>
                                </Card>
